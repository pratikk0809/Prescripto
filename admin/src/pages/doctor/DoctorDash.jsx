  ...
  return dashData && (
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white rounded p-4 min-w-52 border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
            ...
            dashData.latestAppointments.map((item, index) => (
              <div className='flex items-center px-6 gap-3 py-3 hover:bg-gray-100' key={index}>
                ...
                <div className='flex-1 text-sm'>
                  ...
                  <p className='text-gray-6'>{slotDateFormat(item.slotDate)}</p>
                </div>
                {
                  item.cancelled
