...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            // Send address as an object instead of string
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    <label htmlFor="doc-img">
                        <img className='w-40 bg-gray-100 rounded cursor-pointer' src={docImg ? URL.createObjectURL(docImg) : assets.upload_area} alt="" />
                    </label>
                ...
                <button type='submit' className=' mt-4 bg-primary text-white text-base rounded-full py-2 px-8'>Add Doctor</button>
            </div>
