...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center text-sm py-5 mb-5 border-b border-gray-200'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 font-medium text-lg px-5'>
